export default {
  ...
  'codexStatus.codexOnly': 'The /status command is only available for Codex agents.',
  'codexStatus.failed': 'Failed to load Codex usage.',
  'codexStatus.fiveHour': '5-hour remaining',
  'codexStatus.resetsAt': 'resets at {{date}}',
  'codexStatus.unavailable': 'No Codex rate-limit data is available yet.',
  'codexStatus.unavailableValue': 'Unavailable',
  'codexStatus.updatedAt': 'Updated',
  'codexStatus.weekly': 'Weekly remaining',
  'codexCommand.codexOnly': 'This command is only available for Codex agents.',
  'codexCommand.currentModel': 'Current Codex model: {{model}}',
  'codexCommand.modelHelp': 'Switch models with `/model <model>`, for example `/model gpt-5.4`.',
  'codexCommand.modelChanged': 'Codex model changed to {{model}}.',
  'codexCommand.noModels': 'No available Codex models were found.',
  'codexCommand.noSkills': 'No Codex skills were found.',
  'codexCommand.projectSkills': 'Project skills',
  'codexCommand.skillHelp':
    'Run a skill with `/skill <name> <task>`, for example `/skill imagegen create a logo`.',
  'codexCommand.systemSkills': 'Codex built-in skills',
  'codexCommand.userSkills': 'User skills',
  'codexRuntime.context': 'Context',
  'codexRuntime.fiveHour': '5h',
  'codexRuntime.weekly': 'Week',
